...
export default function Execution() {
  ...
  // price is unknown until backend confirms — user enters quantity
  // backend validates price, ticker existence, and balance internally
  ...
  const handleExecute = async () => {
    ...
    try {
      ...
      // backend returns updated portfolio after trade
      setUser((prev) => ({
        ...prev,
        portfolios: {
          ...prev.portfolios,
      ...
      // refresh user balance from /user endpoint
        ...
        <div className="space-y-4 lg:col-span-2">
          <div className={`card-surface space-y-5 border-t-4 p-6 ${isBuy ? "border-t-emerald-500" : "border-t-red-500"}`}>
            ...
            <div>
              ...
              <div className="mt-1 flex justify-between text-xs text-muted-foreground">
                <span>Price confirmed at execution</span>
            ...
            <button
              ...
              className={`flex w-full items-center justify-center gap-2 rounded-lg py-4 text-sm font-bold uppercase tracking-wider text-white transition-colors ${
            ...
            <p className="text-center text-[10px] text-muted-foreground">
              By clicking {isBuy ? "BUY" : "SELL"}, you agree to EdgeXchange&apos;s
              Terms of Service and Risk Disclosure statement.
            </p>
          </div>
          ...
          <div className="card-surface flex items-start gap-3 p-4">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Your trades are protected by SIPC insurance up to $500,000 for
