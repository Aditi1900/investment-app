                                    ...
                                    <div className="flex items-center justify-between">
                                        <div>
                                            ...
                                            <div className="text-xs text-muted-foreground">
                                                {p.isLoading ? "" : p.isEmpty ? "No holdings" : `${p.holdings.length} stocks`}
                                            </div>
                                        </div>
                                        <span className="text-xs font-medium text-muted-foreground">
                                            {p.isLoading ? "" : p.totalValue}
                                        </span>
                                    </div>
                                    ...
                                    <div className="relative mx-auto my-6 h-40 w-40">
                                        {p.isLoading ? (
                                            <div className="relative h-full w-full">
                                                ...
                                                <div
                                                    className="absolute inset-0 rounded-full border-[20px] border-transparent border-t-muted-foreground opacity-40 animate-spin"
